 ...
 */
package org.xwiki.contrib.xcopy.internal;
...
import org.xwiki.contrib.xcopy.AbstractXCopyJob;
import org.xwiki.contrib.xcopy.XCopyConfiguration;
 ...
 */
@Component
@Named(XCopyJob.JOB_TYPE)
public class XCopyJob extends AbstractXCopyJob
{
    /**
     * The job type.
     */
    public static final String JOB_TYPE = "xcopy";

    protected void doPublish(XCopyConfiguration config) throws QueryException, XWikiException
    {
            ...
            throws XWikiException
    {
        ...
        if (!originalTargetDocument.equals(targetDocument)) {
            xwiki.saveDocument(targetDocument, "xcopy-job", xcontext);
            logger.info("Document {} was saved.", serializer.serialize(targetDocument.getDocumentReference()));
        } else {
            logger.info("Document was not updated since the last xcopy: {}.",
