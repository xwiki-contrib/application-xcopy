 ...
 */
package org.xwiki.contrib.xcopy;
...
/**
 * Superclass of xcopy jobs defining general behaviour and utility methods.
 *
 * @version $Id$
 */
public abstract class AbstractXCopyJob extends AbstractJob<DefaultRequest, DefaultJobStatus<DefaultRequest>>
{
    /**
     * Job configuration key used in the Job request, typically in a Groovy script for setting configuration objects in
     * the request.
     */
    public static final String PUBLICATION_JOB_CONFIGURATION_KEY = "xcopy.configuration.key";
    ...
    protected void runInternal()
    {
        try {
            ...
            XCopyConfiguration config = getRequest().getProperty(PUBLICATION_JOB_CONFIGURATION_KEY);
    ...
    protected abstract void doPublish(XCopyConfiguration config) throws QueryException, XWikiException;
